...
/*!
	...
	v1.2  - Added conversion timing for all datarate - Nipoutch
*/
/**************************************************************************/
...
/*=========================================================================
    ...
    -----------------------------------------------------------------------*/
    #define ADS1015_CONVERSIONDELAY_128		(8000)
	#define ADS1015_CONVERSIONDELAY_250		(4000)
	#define ADS1015_CONVERSIONDELAY_490		(2100)
	#define ADS1015_CONVERSIONDELAY_920		(1100)
	#define ADS1015_CONVERSIONDELAY_1600	(652)
	#define ADS1015_CONVERSIONDELAY_2400	(452)
	#define ADS1015_CONVERSIONDELAY_3300	(356)
	...
	#define ADS1015_CONVERSIONDELAY         (356)
    //#define ADS1115_CONVERSIONDELAY         (8) //=>FOR 128 SPS
	#define ADS1115_CONVERSIONDELAY        (1200) //=>FOR 860 SPS
/*=========================================================================*/
...
/*=========================================================================
    ...
    #define ADS1015_REG_CONFIG_DR_128SPS    (0x0000)  // 128 samples per second on ADS1015 
    #define ADS1015_REG_CONFIG_DR_250SPS    (0x0020)  // 250 samples per second on ADS1015 
    #define ADS1015_REG_CONFIG_DR_490SPS    (0x0040)  // 490 samples per second on ADS1015 
    #define ADS1015_REG_CONFIG_DR_920SPS    (0x0060)  // 920 samples per second on ADS1015 
    #define ADS1015_REG_CONFIG_DR_1600SPS   (0x0080)  // 1600 samples per second on ADS1015 
    #define ADS1015_REG_CONFIG_DR_2400SPS   (0x00A0)  // 2400 samples per second on ADS1015 
    #define ADS1015_REG_CONFIG_DR_3300SPS   (0x00C0)  // 3300 samples per second on ADS1015 
